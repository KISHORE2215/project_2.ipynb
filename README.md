...
#Project Overview This project, DataSpark: Illuminating Insights for Global Electronics, focuses on analyzing the retail data of Global Electronics, a leading consumer electronics retailer. The project involves data cleaning, SQL-based analysis, and data visualization using Power BI to provide actionable insights that enhance marketing strategies, optimize inventory management, and improve overall business performance.

#Skills Gained: ->Data Cleaning and Preprocessing
